...
public class MainActivity extends AppCompatActivity {
    ...
    int type = 0;
    String[] str_array = new String[]{"일요일(SUN)", "월요일(MON)", "화요일(TUE)", "수요일(WED)",
            "목요일(THU)", "금요일(FRI)", "토요일(SAT)"};
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.item4:
                type = 4;
                characterArrayAdapter = ArrayAdapter.createFromResource(this, R.array.list1, android.R.layout.simple_list_item_1);
                break;
